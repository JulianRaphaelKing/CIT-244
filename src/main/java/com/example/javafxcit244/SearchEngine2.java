...
public class SearchEngine2 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Info Button
        Button infoBtn = new Button("More Information");
...
//        });
        ...
        searchButton.setOnAction((e) -> {
            ...
            pane.setCenter(setImage(searchTF.getText(), infoBtn));
            searchTF.clear();
        ...
        topBox.getChildren().addAll(title, searchTF, searchButton, infoBtn);
    ...
    public static ImageView setImage(String search, Button infoBtn){
        ...
        try{
            ...
            infoBtn.setVisible(false);
            System.out.println("Search query failed... here's a cat instead");
        }
    ...
    public static void getInfo(String search){
        Stage infoStage = new Stage();
        TextArea information = new TextArea();

        Scene infoScene = new Scene(information);
